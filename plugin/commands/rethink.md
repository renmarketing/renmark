...
Read `${CLAUDE_PLUGIN_ROOT}/skills/rethink/SKILL.md` and follow its instructions exactly. The user provided this input: $ARGUMENTS

If `$ARGUMENTS` is empty, begin the rethink skill's flow.
