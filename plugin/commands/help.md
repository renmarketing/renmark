...
Read `${CLAUDE_PLUGIN_ROOT}/skills/help/SKILL.md` and follow its instructions exactly. The user provided this input: $ARGUMENTS

If `$ARGUMENTS` is empty, begin the help skill's flow.
