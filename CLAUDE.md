...
**Entry points:** `bin/renmark-execute`, `bin/renmark-browser`, `renmark/__main__.py`, `plugin/commands/*.md`
**Optional browser layer:** `pip install renmark[browser]` (Playwright) enables session-memory QA; absent, verify falls back to the Chrome DevTools MCP.
