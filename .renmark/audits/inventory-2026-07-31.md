...
artifact_type: audit
schema_version: 1
created_at: 2026-08-01T03:41:35+00:00
source_sha: b2828c9eb8c6e9e0a228bbbeec08dba463e401f8
related_plan: null
...
| codereview | debug | gate | 2 | 378 | Use when the user wants a diff or PR reviewed — typed as /renmark:codereview or … |
| debug | debug | aux | 2 | 141 | Use for the Debug pipeline (/renmark:debug) when something is broken — plain req… |
...
| feature | build | pipeline | 2 | 310 | Use for the Feature pipeline (/renmark:feature) when adding to or changing an ex… |
| finish | build | pipeline | 2 | 528 | Use for the Ship / Readiness pipeline (/renmark:finish) when implementation is d… |
| guide | meta | aux | 2 | 80 | Use when the user types /renmark:guide or says \"I don't know which command to u… |
...
| init | meta | aux | 2 | 245 | Use for the Project Setup pipeline (/renmark:init) to adopt renmark into a repo … |
...
| start | build | pipeline | 2 | 275 | Use for the New Build pipeline (/renmark:start) when starting something new from… |
