...
artifact_type: audit
schema_version: 1
created_at: 2026-06-11T21:15:22+00:00
source_sha: 4df6c3001ab60108557702a1d64416404c71dd1b
related_plan: null
...
| audit | audit | aux | 2 | 110 | Use to run a deterministic plugin/registry health audit — composes the lint, mod… |
...
| check-plan | build | pipeline | 2 | 100 | Use before executing a renmark plan — deterministic validation via renmark.plan_… |
| codereview | debug | gate | 2 | 321 | Use when the user wants a diff or PR reviewed — typed as /renmark:codereview or … |
...
| orchestrate | build | pipeline | 2 | 299 | Use to execute a renmark plan — `/renmark:orchestrate` or "execute the plan", "b… |
| plan | build | pipeline | 2 | 236 | Use when the user has a spec and wants it decomposed into an executable task lis… |
