...
artifact_type: audit
schema_version: 1
created_at: 2026-06-25T18:09:49+00:00
source_sha: 95bc9c9735aa2e891affae42e848d7b9ddf2f747
related_plan: null
...
| orchestrate | build | pipeline | 2 | 323 | Use to execute a renmark plan — `/renmark:orchestrate` or \"execute the plan\", … |
| plan | build | pipeline | 2 | 244 | Use when the user has a spec and wants it decomposed into an executable task lis… |
| prd | build | pipeline | 2 | 182 | Use when the user wants to author or maintain the project's Product Requirements… |
...
| start | build | pipeline | 2 | 235 | Use for the New Build pipeline (/renmark:start) when starting something new from… |
