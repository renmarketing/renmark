...
artifact_type: audit
schema_version: 1
created_at: 2026-07-01T14:48:22+00:00
...
| finish | build | pipeline | 2 | 393 | Use for the Ship / Readiness pipeline (/renmark:finish) when implementation is d… |
...
| orchestrate | build | pipeline | 2 | 341 | Use to execute a renmark plan — `/renmark:orchestrate` or \"execute the plan\", … |
