...
<!-- Last refreshed: 2026-06-17 @ 05e35e4 -->
...
**163 modularity gaps** (24 major, 139 warn) — file-level size/complexity breaches. Advisory: these never block init.
...
- _… +143 more (re-run for the full list)_
