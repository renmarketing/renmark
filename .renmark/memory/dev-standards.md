...
<!-- Last refreshed: 2026-07-06 @ 2e2f2e9 -->

# Dev standards — precious-mixing-pie
...
**196 modularity gaps** (32 major, 164 warn) — file-level size/complexity breaches. Advisory: these never block init.
...
- _… +176 more (re-run for the full list)_
