...
<!-- Last refreshed: 2026-06-14 @ 3c37a60 -->
...
**155 modularity gaps** (24 major, 131 warn) — file-level size/complexity breaches. Advisory: these never block init.
...
- _… +135 more (re-run for the full list)_
