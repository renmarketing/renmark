...
<!-- Last refreshed: 2026-06-14 @ 41b66fd -->
...
**154 modularity gaps** (24 major, 130 warn) — file-level size/complexity breaches. Advisory: these never block init.
...
- 🚨 **Oversized module: `renmark/init.py` (1245 code lines)** — `renmark/init.py` has 1245 code lines (threshold 1000). Large modules are hard to navigate, review, and test, and tend to accrete unrelated responsibilities. _Split `renmark/init.py` into focused modules along its natural seams (one cohesive responsibility per file). Advisory — never auto-refactored._
...
- _… +134 more (re-run for the full list)_
