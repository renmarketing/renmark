...
| Release | Title | Type | Built from | Lifecycle status |
|---|---|---|---|---|
| **R-0.3** | Minimal Canonical Ledger | feature | narrowed subset of Phase 3 (Work Order, Work Result, Inspection Report, Escalation only — blueprint/milestone-contract/closeout schemas, hashing, snapshot/restore, migration adapters deferred) | **PLANNED** — contract drafted `.renmark/plans/2026-08-01-r-0.3-minimal-canonical-ledger-contract.md`, awaiting Owner approval. Carries R-0.2's F1/F2/F4/F5 as tracked (not in-scope) dependencies per Owner instruction. |
